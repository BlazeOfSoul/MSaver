...
@Component({
    selector: 'app-income-chart-tab',
    standalone: true,
    imports: [CommonModule, DropdownModule, ChartModule, FormsModule],
    templateUrl: './income-chart-tab.component.html',
    styleUrls: ['./income-chart-tab.component.scss'],
})
export class IncomeChartTabComponent {
    @Input() months: { name: string; index: number }[] = [];
    @Input() incomeChartDataByMonth: any[] = [];
